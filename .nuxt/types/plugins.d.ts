...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../src/plugins/01.me.client").default> &
  InjectionType<typeof import("../../src/plugins/02.users.client").default> &
  InjectionType<typeof import("../../src/plugins/03.chats.client").default> &
  InjectionType<typeof import("../../src/plugins/03.rooms.client").default> &
  InjectionType<typeof import("../../src/plugins/04.ws.client").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed' | 'me' | 'users' | 'chats' | 'rooms' | 'ws'
  }
}
